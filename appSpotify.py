...
def main():
    ...
    if "access_token" in st.session_state:
        ...
        mood = st.selectbox("Selecciona tu estado de ánimo deseado:", ["Trabajo", "Concentración", "Descanso"])
        genres = st.multiselect("Selecciona los géneros musicales:", ["Rock 80s y 90s", "Rock Progresivo", "Rock Pesado", "Hip Hop"])
